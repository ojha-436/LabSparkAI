...
const CATALOG = [
  ...
  { id: "reactions", name: "Types of Chemical Reactions", cls: "Class 10", subject: "Chemistry",
    diff: "Medium", mins: 12, xp: 120, c: C.coral, status: "ready", icon: "atom",
    blurb: "Sort reactions into combination, decomposition, displacement and double displacement.",
    chapter: "Ch 1 · Chemical Reactions and Equations" },
  { id: "lens", name: "Converging & Diverging Lenses", cls: "Class 10", subject: "Physics",
    diff: "Medium", mins: 11, xp: 110, c: C.violet, status: "ready", icon: "eye",
    blurb: "Pass parallel rays through lenses to tell convex from concave.",
  ...
  /* ── Class 10 — extra labs ── */
  { id: "metals-reactivity", name: "The Reactivity Series of Metals", cls: "Class 10", subject: "Chemistry",
    diff: "Medium", mins: 11, xp: 110, c: C.gold, status: "ready", icon: "flask",
    blurb: "Rank metals from highly to least reactive by how they react.",
    chapter: "Ch 3 · Metals and Non-metals" },
  { id: "carbon-compounds", name: "Carbon Compounds & Functional Groups", cls: "Class 10", subject: "Chemistry",
    diff: "Medium", mins: 11, xp: 110, c: C.violet, status: "ready", icon: "atom",
    blurb: "Identify hydrocarbons, alcohols and carboxylic acids by their group.",
    chapter: "Ch 4 · Carbon and its Compounds" },
  { id: "salts", name: "Acidic, Basic & Neutral Salts", cls: "Class 10", subject: "Chemistry",
    diff: "Medium", mins: 10, xp: 100, c: C.em, status: "ready", icon: "beaker",
    blurb: "Classify common salts by the pH of their solution.",
    chapter: "Ch 2 · Acids, Bases and Salts" },
  { id: "electricity", name: "Series & Parallel Circuits", cls: "Class 10", subject: "Physics",
    diff: "Medium", mins: 11, xp: 110, c: C.coral, status: "ready", icon: "bolt",
    blurb: "Tell series circuits from parallel ones in everyday wiring.",
    chapter: "Ch 12 · Electricity" },
  { id: "human-eye", name: "Defects of Vision", cls: "Class 10", subject: "Physics",
    diff: "Medium", mins: 10, xp: 100, c: C.violet, status: "ready", icon: "eye",
    blurb: "Diagnose myopia and hypermetropia and their corrective lenses.",
    chapter: "Ch 11 · The Human Eye and the Colourful World" },
  { id: "magnetic-effects", name: "Electric Motor & Generator", cls: "Class 10", subject: "Physics",
    diff: "Medium", mins: 11, xp: 110, c: C.sky, status: "ready", icon: "refresh",
    blurb: "Sort devices into motors and generators by their principle.",
